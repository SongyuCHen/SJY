...
public class PbcatfmtId implements java.io.Serializable
{
	...
	public boolean equals(Object other)
	{
		...
		return ((this.getPbfName() == castOther.getPbfName()) || (this
				.getPbfName() != null && castOther.getPbfName() != null && this
				.getPbfName().equals(castOther.getPbfName())))
				&& ((this.getPbfFrmt() == castOther.getPbfFrmt()) || (this
						.getPbfFrmt() != null && castOther.getPbfFrmt() != null && this
						.getPbfFrmt().equals(castOther.getPbfFrmt())))
				&& (this.getPbfType() == castOther.getPbfType())
				&& ((this.getPbfCntr() == castOther.getPbfCntr()) || (this
						.getPbfCntr() != null && castOther.getPbfCntr() != null && this
						.getPbfCntr().equals(castOther.getPbfCntr())));
	}
	...
	public int hashCode()
	{
		...
		result = 37 * result
				+ (getPbfName() == null ? 0 : this.getPbfName().hashCode());
		result = 37 * result
				+ (getPbfFrmt() == null ? 0 : this.getPbfFrmt().hashCode());
		result = 37 * result + this.getPbfType();
		result = 37 * result
				+ (getPbfCntr() == null ? 0 : this.getPbfCntr().hashCode());
		return result;
	}
