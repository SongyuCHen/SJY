...
public class PbcatedtId implements java.io.Serializable
{
	...
	public PbcatedtId(String pbeName, String pbeEdit, short pbeType,
			short pbeSeqn)
	{
	...
	public PbcatedtId(String pbeName, String pbeEdit, short pbeType,
			Integer pbeCntr, short pbeSeqn, Integer pbeFlag, String pbeWork)
	{
		this.pbeName = pbeName;
		this.pbeEdit = pbeEdit;
		this.pbeType = pbeType;
	...
	public boolean equals(Object other)
	{
		...
		return ((this.getPbeName() == castOther.getPbeName()) || (this
				.getPbeName() != null && castOther.getPbeName() != null && this
				.getPbeName().equals(castOther.getPbeName())))
				&& ((this.getPbeEdit() == castOther.getPbeEdit()) || (this
						.getPbeEdit() != null && castOther.getPbeEdit() != null && this
						.getPbeEdit().equals(castOther.getPbeEdit())))
				&& (this.getPbeType() == castOther.getPbeType())
				&& ((this.getPbeCntr() == castOther.getPbeCntr()) || (this
						.getPbeCntr() != null && castOther.getPbeCntr() != null && this
						.getPbeCntr().equals(castOther.getPbeCntr())))
				&& (this.getPbeSeqn() == castOther.getPbeSeqn())
				&& ((this.getPbeFlag() == castOther.getPbeFlag()) || (this
						.getPbeFlag() != null && castOther.getPbeFlag() != null && this
						.getPbeFlag().equals(castOther.getPbeFlag())))
				&& ((this.getPbeWork() == castOther.getPbeWork()) || (this
						.getPbeWork() != null && castOther.getPbeWork() != null && this
						.getPbeWork().equals(castOther.getPbeWork())));
	}
	...
	public int hashCode()
	{
		...
		result = 37 * result
				+ (getPbeName() == null ? 0 : this.getPbeName().hashCode());
		result = 37 * result
				+ (getPbeEdit() == null ? 0 : this.getPbeEdit().hashCode());
		result = 37 * result + this.getPbeType();
		result = 37 * result
				+ (getPbeCntr() == null ? 0 : this.getPbeCntr().hashCode());
		result = 37 * result + this.getPbeSeqn();
		result = 37 * result
				+ (getPbeFlag() == null ? 0 : this.getPbeFlag().hashCode());
		result = 37 * result
				+ (getPbeWork() == null ? 0 : this.getPbeWork().hashCode());
		return result;
	}
