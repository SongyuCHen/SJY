...
public class PlkhExcelBuilder extends AbstractExcelView
{
	...
	{
		List<MPfkh> mlist = (List<MPfkh>) model.get("plkhList");
		
		// 创建Sheet
        HSSFSheet sheet = workbook.createSheet("批量考核");
     ...
     // 创建样式
        ...
        String filename = "批量考核-"+curDateStr+".xls";
