...
<body>
	...
	<div id="wrapper">
		...
		<div id="operationDiv" class="btn-group">
			...
			<div class="btn-group">
	            ...
	            <ul class="dropdown-menu">
		            <li><a href="#addKflbModal" data-toggle="modal">新增</a></li>
		            <li><a href="#" id="editKflbLink">编辑</a></li>
		            <li><a href="#" id="deleteKflbLink">删除</a></li>
	            </ul>
            </div>
        </div>
		...
		<div id="content">
			<div id="table_content">
				<table id="kflbTable" class="table table-bordered">
					<colgroup>
					...
					<thead>
						<tr>
							<th>
								<!-- <input type="checkbox" name="kflbbh" id="kflbbhAll" /> -->
							</th>
							<th>编号</th>
							<th>类别名称</th>
						</tr>
					...
					<tbody>
						<c:forEach items="${kflbList}" var="kflb">
							<tr>
								<td>
									<input type="checkbox" class="kflbCheckbox" name="kflbbh" value="${kflb.bh}" data-mc="${kflb.mc }">
								</td>
								<td>${kflb.pzbh }</td>
								<td>${kflb.mc }</td>
							</tr>
	...
	<div id="addKflbModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
		<div class="modal-dialog">
			<form action="${pageContext.request.contextPath}/kfqx/addKflb" id="addJfqxForm"
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="">扣分类别</h4>
				</div>
	...
	<div id="editKflbModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
		<div class="modal-dialog">
			<form action="${pageContext.request.contextPath}/kfqx/editKflb" id="editJfqxForm"
							method="post" class="form-horizontal">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-body" id="modalBodyDiv">
					<input type="hidden" id="modalKflbbh" name="kflbbh" />					
					<div class="form-group">
						<label class="col-lg-4 control-label">类别名称</label>
						<div class="col-lg-4">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/kflb.js"></script>
</body>
</html>